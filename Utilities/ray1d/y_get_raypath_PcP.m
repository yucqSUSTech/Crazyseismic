function [ zdt  ] = y_get_raypath_PcP( evdp, rayp, em )
...
for i = 1:length(rayp)
    ...
    [rtmp1,dtmp1,dd1,zz1,etab1,edtab1] = tau_raypath_v2(evdp,em.z_cmb,pj,z_fine,sp_fine);
    [rtmp2,dtmp2,dd2,zz2,etab2,edtab2] = tau_raypath_v2(0,em.z_cmb,pj,z_fine,sp_fine);
