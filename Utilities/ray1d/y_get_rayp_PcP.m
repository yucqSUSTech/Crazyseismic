function [ rayp ] = y_get_rayp_PcP( evdp, em, dist, np )
...
[rtmp1, dtmp1]=  tau (evdp, em.z_cmb, pmin, z_fine, sp_fine);
[rtmp2, dtmp2]= tau ( 0.0, em.z_cmb, pmin, z_fine, sp_fine);
dtaup = dtmp1 + dtmp2;
range1 = dtaup*180/pi;
[rtmp1, dtmp1]=  tau (evdp, em.z_cmb, pmax, z_fine, sp_fine);
[rtmp2, dtmp2]= tau ( 0.0, em.z_cmb, pmax, z_fine, sp_fine);
dtaup = dtmp1 + dtmp2;
range2 = dtaup*180/pi;
...
for i = 1:length(dist)
    ...
    while ddist > 0.001 && num < 30 % ~0.1 km offset
        num = num + 1;
        pj = (pmax + pmin)/2;
        [rtmp1, dtmp1]=  tau (evdp, em.z_cmb, pj, z_fine, sp_fine);
        [rtmp2, dtmp2]= tau ( 0.0, em.z_cmb, pj, z_fine, sp_fine);
%         taup = rtmp1 + rtmp2;
        dtaup = dtmp1 + dtmp2;
