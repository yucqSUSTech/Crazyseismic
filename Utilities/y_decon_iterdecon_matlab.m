function [RFI,RMS] = y_decon_iterdecon_matlab(UIN,WIN,DT,NT,TSHIFT,F0,ITMAX,MINDERR)

% this code is copied from Ligorria and Ammon 
% - Chunquan Yu, 04/04/2012

% common values for several parameters:
% TSHIFT = 20;
% F0 = 2.5;
% ITMAX = 100;
% MINDERR = 0.001;
