...
para.linewidth_show = 0.5; % line width of regular traces
para.linewidth_selected = 1; % line width of selected traces
...
para.signalwin = [-50 50];
para.noisewin = [-300 -50];
